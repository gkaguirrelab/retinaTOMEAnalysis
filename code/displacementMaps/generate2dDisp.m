...
for i = 1:length(rotDegs)
    ...
    mapFull(mapFullMidPt,mapFullMidPt:end,i) = calcDisplacement(RFdensity_mm,sampleBase_RF_mm,RGCdensity_mmSq,sampleBase_RGC_mm,radMM,smpPerMM,sectorAngle,'OFF');
