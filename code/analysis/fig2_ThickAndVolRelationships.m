...
h=profilePlot(XPos_Degs, gcVec, meanGCVec, 'Eccentricity [deg visual angle]','GC Thickness [microns]',[],1);
setTightFig
...
h=regressionPlot(comboTable.Axial_Length_average, comboTable.gcMeanThick, 'Axial Length [mm]','Mean GC Thickness [microns]', [],1);
setTightFig
