...
%% rotate and crop
RF_crop   = imrotate(RFdensity,-1.*rotDeg,'crop','nearest');
RGC_crop  = imrotate(RGCdensity,-1.*rotDeg,'crop','nearest');
...
RGCdenisty_mmSq = RGC_crop(RGC_midPoint,RGC_midPoint:end);
